...
struct pluginMethod {
    ...
    static let readMessage : String                 = "read_message"
    ...
    static let retractMessage : String              = "retract_message"
    static let enablePush : String                  = "enable_push"
}
...
struct eleRead {
    /// Value - read
    static let Name : String = "read"
    /// Value - urn:xmpp:read
    static let Namespace : String = "urn:xmpp:read"
    /// Value - id
    static let Key : String = "id"
}
