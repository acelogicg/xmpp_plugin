...
public class Constants {
    ...
    public static final String PUSH_JID = "push_jid";
    ...
    public static final String READ_MESSAGE_METHOD = "read_message";
    ...
    public static final String URN_XMPP_READ = "urn:xmpp:read";
